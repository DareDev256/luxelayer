export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-16 overflow-hidden">
      {/* Background gradient */}
      <div className="absolute inset-0 bg-gradient-to-b from-charcoal via-[#0d0d0d] to-[#0d0d0d]" />
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        ...
        <p className="text-lg md:text-xl text-warm-gray/60 max-w-2xl mx-auto mb-10 animate-fade-in-up-delay-2">
        ...
        {/* Trust signals */}
        <div className="mt-16 flex flex-wrap items-center justify-center gap-8 text-warm-gray/40 text-sm">
